...
always @(*) begin
    ...
    out_state[1][0] = in_state[1][3];
    out_state[1][1] = in_state[1][0];
    out_state[1][2] = in_state[1][1];
    out_state[1][3] = in_state[1][2];
    ...
    out_state[3][0] = in_state[3][1];
    out_state[3][1] = in_state[3][2];
    out_state[3][2] = in_state[3][3];
    out_state[3][3] = in_state[3][0];
end
