module aes_sbox (
    ...
    // Hard-coded S-box look-up table (256 entries of 8-bit values)
    reg [7:0] sbox [0:255];
    ...
    // SubBytes operation: parallel substitution for all 16 bytes
    always @(*) begin
        for (i = 0; i < 4; i = i + 1) begin
            for (j = 0; j < 4; j = j + 1) begin
                // The byte from in_state is the index into the sbox
